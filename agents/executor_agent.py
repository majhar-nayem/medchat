...
Provide a clear, caring response in 2-4 sentences. Be professional and reassuring."""
        ...
        try:
            ...
            print(f"Error in ExecutorAgent LLM call: {str(e)}")
            answer = "I apologize, but I'm experiencing technical difficulties. Please consult a healthcare professional for medical advice."
            state["generation"] = answer
            state["source"] = "System Message"
